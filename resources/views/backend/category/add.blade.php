			    ...
			    <div id="myTabContent" class="tab-content">
			      <div class="tab-pane active in" id="home">
			    	...
			    	<form id="tab" action="{{ route('admin.category.store') }}" method="post">
				        ...
				        <label>栏目名称</label>
				        <input type="text" value="" name="name" class="span10" required="true" >
				        <label>栏目标识</label>
				        <input type="text" value="" name="mark" class="span10" required="true">
				        <label>栏目描述</label>
						<textarea value="" name="description" rows="8" class="span10" required="true">	
				        </textarea>
